...
const Sidebar = () => {
  ...
  return (
    <nav className="flex h-screen min-w-[16rem] flex-col justify-between p-8">
        ...
        <ul className="flex flex-col gap-6">
            ...
            <Link href="/create-quiz">
              <button
                className={classNames(
                  "w-full rounded-2xl border-2 border-[#2B8585] px-4 py-4 text-left font-semibold text-[#2B8585] transition duration-200 ease-in-out hover:brightness-90",
                  {
                    "bg-[#2B8585] text-white transition duration-200 ease-in-out hover:brightness-90":
          ...
          <li>
            <Link href="/">
              <button
                className={classNames("", {
                  "w-full rounded-2xl bg-[#F39D10] px-4 py-4 text-left font-semibold text-white transition duration-200 ease-in-out hover:brightness-90":
                    router.pathname === "/" ||
      ...
      <section>
        <Link href="/login">
          <button className="w-full rounded-2xl bg-[#2B8585] px-4 py-4 text-left font-semibold text-white transition duration-200 ease-in-out hover:brightness-90">
