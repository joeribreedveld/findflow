...
const Login: NextPage = () => (
  <div className="flex min-h-screen items-center justify-center bg-[url(/img/map.jpg)]">
    <section className="flex flex-col items-center rounded-2xl bg-white p-16">
      ...
      <form className="mt-8 flex w-[22rem] flex-col gap-4">
        ...
        />
        <Link href="/">
          <button className="mt-8 w-full rounded bg-[#2B8585] py-4 text-white transition duration-200 ease-in-out hover:brightness-90">
            Login
          </button>
        </Link>
      </form>
